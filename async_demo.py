...
class AsyncScheduler:
    def __init__(self, batch_size=3, max_workers=6, total_max=20, factor=1.0):
        self.factor = factor
        self.batch_size = batch_size
        self.total_max = total_max
        self.init_n = 20  # 首次生产和消费数量
    ...
    async def producer(self):
        ...
        while self.running:
            ...
            if self.total_product_count == 0: # 首次生产
                num_to_produce = self.init_n  # 首次生产更多一些
    ...
    async def consumer(self):
        ...
        while self.running:
            ...
            for _ in range(int(comsum_n*self.factor)):
                ...
                #print(f"  [消费者]: 开始消费 产品={self.totoal_consume_count} | 总消费数量: {self.totoal_consume_count}")
